...
export default function TextForm(props) {
    ...
    <div className="container" style={{color : props.mode==='dark'?'white':'black'}}>
        ...
        <div>
            <button disabled={text.length===0} className={`btn btn-${props.c} mt-3 me-3`} onClick={handleUpClick}>Convert to UpperCase</button>
            <button disabled={text.length===0} className={`btn btn-${props.c} mt-3 me-3`} onClick={handleloClick}>Convert to LowerCase</button>
            <button disabled={text.length===0} className={`btn btn-${props.c} mt-3 me-3`} onClick={handleClear}>Clear Text</button>
            <button disabled={text.length===0} className={`btn btn-${props.c} mt-3 me-3`} onClick={speak}>Read Text</button>
            <button disabled={text.length===0} className={`btn btn-${props.c} mt-3 me-3`} onClick={copyclipboard}>Copy To Clipboard</button>
            <button disabled={text.length===0} className={`btn btn-${props.c} mt-3 me-3`} onClick={RemoveSpace}>Remove Extra Space</button>
        </div>
    </div>
        ...
        <div className="row mb-5">
            ...
            <div className="col-md-4">
                <div className={`border border-${props.mode==='dark'?'white':'#281b7d'} p-2 pt-3 mb-3`}>
                    ...
                    <button disabled={find.length===0 || replace.length===0} className={`btn btn-${props.c} mt-2`} onClick={replacefr}><i className="bi-arrow-down-up"></i></button>
